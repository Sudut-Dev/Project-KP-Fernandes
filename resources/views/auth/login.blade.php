...
<head>
    ...
    <title>Login | Sistem Informasi Manajemen Rapat Online</title>
</head>
                        ...
                        <div class="row g-0">
                            <div class="col-lg-12">
                                <div class="card-body p-4 p-sm-5">
                                    <center>
                                        <img width="300px" src="{{ asset('images/icons/PUPUK KALTIM.jpg') }}"
                                            alt="">
                                    </center>
                                    <h4 class="card-title text-center mt-4">SI-MANAJEMEN RAPAT ONLINE</h4>

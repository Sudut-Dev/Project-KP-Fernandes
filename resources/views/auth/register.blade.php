...
<head>
    ...
    <title>Daftar Peminjam | MEETING SCHEDULE SYSTEM</title>
</head>
                        ...
                        <div class="row g-0">
                            <div class="col-lg-12">
                                <div class="card-body p-4 p-sm-5">
                                    <center>
                                        <img width="150px" src="{{ asset('images/icons/PUPUK KALTIM') }}"
                                            alt="">
                                    </center>
                                    <h4 class="card-title text-center mt-4">MEETING SCHEDULE SYSTEM</h4>

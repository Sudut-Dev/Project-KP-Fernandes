        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item schedule" aria-current="page">Kelola Links</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-end">
                {{-- schedule buttons --}}
                <div>
                    <a href="{{ route('links.create') }}" class="btn btn-sm" title="Tambah link"
                ...
                <div class="ms-auto position-relative">
                    ...
                    <form action="{{ route('links.search') }}" method="GET">
                        <input name="key" class="form-control ps-5" type="text" placeholder="Cari link.."
                            autocomplete="off">
                    </form>
                </div>
            </div>
            <div id="schedules-table-wrapper" class="table-responsive mt-3">
                <table id="schedules-table" class="table table-sm align-middle">
                        ...
                        <tbody>
                            @foreach ($schedules as $i => $schedule)
                                <tr>
                                    <td>{{ $i + 1 }}</td>
                                    <td>{{ $schedule->link }}</td>
                                    <td>{{ $schedule->vroom ? $schedule->vroom->name : '' }}</td>
                                    ...
                                    <td>
                                        <center>
                                            <div data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                title="Tampilkan Detail link" class="d-inline">
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <div class="table-actions d-flex align-items-center gap-3">
                                            ...
                                            <form action="{{ route('links.edit', $schedule->id) }}"
                                            ...
                                            <div class="modal fade" id="modal-schedule-delete-{{ $schedule->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <form action="{{ route('links.destroy', $schedule->id) }}"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <span>
                                                                    Tekan <strong>OK</strong> untuk hapus link.
                                                                </span>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-light border"
                    ...
                    @else
                        <thead>
                            <h6 class="text-center">Data Link tidak ditemukan.</h6>
                        </thead>
                    @endif
                </table>
            </div>

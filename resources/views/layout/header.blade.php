...
<head>
    ...
    <link href="{{ asset('plugins/select2/css/select2-bootstrap4.min.css') }}" rel="stylesheet" />
    ...
    <title>{{ $title ??= 'Title' }} | MEETING SCHEDULE SYSTEM</title>
</head>
    ...
    <div class="wrapper">
        ...
        <aside class="semi-dark sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                {{-- <a href="/">
                    <img src="{{ asset('images/icons/PUPUK KALTIM.jpg') }}" class="logo-icon" alt="logo icon">
                </a> --}}
                <a href="/">
                    <h6 class="text-center mt-2">Meeting Scheduling System</h6>
                </a>
                    ...
                    <li>
                        ...
                        <li>
                            <a href="{{ route('room.index') }}">
                                ...
                                <div class="menu-title">Kelola P-Room</div>
                            </a>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="menu-title">Kelola Link</div></a>
                        </li>

                        <li>
                            <a href="{{ route('vroom.index')}}">
                            <div class="parent-icon">
                                <i class="fas fa-video"></i>
                            </div>
                            <div class="menu-title">Kelola V-Room</div></a>
                        </li>
                ...
                @if (auth()->user()->role_id == 1)
                    ...
                    <!-- <li>
                        <a href="{{ route('role.index') }}">
                            ...
                            <div class="menu-title">Kelola Role</div>
                        </a>
                    </li> -->
                @endif
            </ul>
